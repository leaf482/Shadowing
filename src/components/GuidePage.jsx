  ...
  return (
    <div className="guide-page">
      ...
      <div className="guide-content">
        ...
        {/* ── 1. How to Use ── */}
        <Section id="how-to-use" eyebrow="Getting Started" title="How to Use Shadow Network">
          ...
          <ol className="guide-list guide-list--ol">
            ...
            <li>Use the <strong>Tracker</strong> to log your shadowing and volunteer hours. Create a project per clinic, log sessions, and export your AADSAS-ready experience summary.</li>
        ...
        {/* ── 4. Disclaimer ── */}
        <Section id="disclaimer" eyebrow="Healthcare Context" title="Disclaimer">
          <div className="guide-callout guide-callout--warn" style={{ marginBottom: "1rem" }}>
        ...
        {/* ── 5. Security ── */}
        <Section id="security" eyebrow="Technical" title="Security Practices">
        ...
        {/* ── 6. Content Rules ── */}
        <Section id="content-rules" eyebrow="Community" title="User Content Rules">
        ...
        {/* ── 7. Reporting ── */}
        <Section id="reporting" eyebrow="Community" title="Reporting Incorrect or Inappropriate Listings">
        ...
        {/* ── 8. Copyright ── */}
        <Section id="copyright" eyebrow="Legal" title="Copyright &amp; Intellectual Property">
          <Ul items={[
